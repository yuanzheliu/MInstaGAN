...
class UnalignedSegDataset(BaseDataset):
	...
	def __getitem__(self, index):
		...
		# seg path 2
		A_seg_path_2 = A_path.replace('A', 'A_{}'.format(self.seg_dir_2))
		B_seg_path_2 = B_path.replace('B', 'B_{}'.format(self.seg_dir_2))
		...
		A_segs_2 = self.read_segs(A_seg_path_2, seed)
		B_segs_2 = self.read_segs(B_seg_path_2, seed)
		...
		return {'A': A, 'B': B,
				...
				'A_segs_2': A_segs_2, 'B_segs_2': B_segs_2,
